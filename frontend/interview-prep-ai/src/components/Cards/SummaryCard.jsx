...
const SummaryCard = ({
    ...
    return (
        <div className='bg-white  border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group ml-22' onClick={onSelect}> 
            ...
            <div className='px-3 pb-3'>
                {/* This flex container keeps the three bubbles in a row */}
                ...
                {/* The description is now on its own line after the flex container */}
